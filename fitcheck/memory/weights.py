...
# Double quantization stores INT8 absmax values plus one FP32 scale per 256 blocks.
# The resulting 0.015869 bytes/param replaces the 0.0625 single-quant overhead.
