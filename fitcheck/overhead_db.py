...
OVERHEAD_DB: dict[tuple[str, str, str], OverheadProfile] = {
    ("t4", "eager", "nf4"): OverheadProfile(
        ...
        hump_fragmentation_logits_win=0.6442,
        hump_fragmentation_layer_win=0.7518,
        seq_len_min=512,
        seq_len_max=4096,
        runs=14,
        worst_over_pct=13.9,
    ...
    ("t4", "eager", "none"): OverheadProfile(
        ...
        quantization="none",
        base_context_mib=140.875,
        hump_fragmentation_logits_win=0.5808,
        hump_fragmentation_layer_win=0.8468,
        seq_len_min=512,
        seq_len_max=4096,
        runs=10,
        worst_over_pct=7.3,
    ...
    ("t4", "flash", "nf4"): OverheadProfile(
        ...
        quantization="nf4",
        base_context_mib=140.875,
        hump_fragmentation_logits_win=1.9683,
    ...
    ("t4", "flash", "none"): OverheadProfile(
        ...
        quantization="none",
        base_context_mib=140.875,
        hump_fragmentation_logits_win=1.3181,
        hump_fragmentation_layer_win=None,
        seq_len_min=512,
        seq_len_max=4096,
        runs=10,
